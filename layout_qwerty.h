int layer0[44] = {
    ...
    KEY_ESC, KEY_TAB, KEYBOARD_LEFT_ALT, KEYBOARD_LEFT_SHIFT, KEY_BACKSPACE, KEYBOARD_RIGHT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_MINUS, KEY_QUOTE, KEYBOARD_LEFT_GUI};
